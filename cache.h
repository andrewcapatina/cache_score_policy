...
enum cache_policy {
  ...
  Score		/* replace the block with lowest SCORE */
};
...
struct cache_blk_t
{
  ...
  unsigned int 	blk_score = INIT_BLOCK_SCORE; /* the 'score' of each cache block */
...
// Prototype function for evicting a cache block. "score_choose_repl()"

// Prototype function for updating scores on a hit

// Prototype function for updating scores on a miss
