	     ...
	     md_addr_t *repl_addr)	/* for address of replaced block */
{
  ...
  case Random:
    ...
    break;
  case Score:
	// add replacement function here
	
	/* update the Score value of each cache block */
	blk->score = blk->score - DECREASE_VELOCITY;
	break;
  default:
 ...
 cache_hit: /* slow hit handler */
  ...
  /* update cache block score */
  blk->score = blk->score + INCREASE_VELOCITY;	// increment by the #define in cache.h
